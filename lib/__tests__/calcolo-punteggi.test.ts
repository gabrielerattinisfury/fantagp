...
const rosaBase: RosaAttivaRiga[] = [
  ...
  { slot: 'moto3_c', pilota_id: 'm3-3', categoria_id: 'cat-moto3', nome_completo: 'Pilota Moto3 Tre', numero: 55 },
  ...
  { slot: 'moto2_c', pilota_id: 'm2-3', categoria_id: 'cat-moto2', nome_completo: 'Pilota Moto2 Tre', numero: 66 },
...
const numeroMotoAbituale = new Map<string, number>([
  ['m3-1', 11], ['m3-2', 22], ['m3-3', 55],
  ['m2-1', 33], ['m2-2', 44], ['m2-3', 66],

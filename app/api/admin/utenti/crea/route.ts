...
const schemaNuovoUtente = z.object({
  ...
  rosa: z.object({
    ...
    moto3C: z.string().uuid(),
    moto2A: z.string().uuid(),
    moto2B: z.string().uuid(),
    moto2C: z.string().uuid(),
...
export async function POST(req: NextRequest) {
  ...
  const righeRosa = [
    ...
    { slot: 'moto3_c', pilota_id: d.rosa.moto3C, categoria_id: idCategoria('Moto3') },
    ...
    { slot: 'moto2_c', pilota_id: d.rosa.moto2C, categoria_id: idCategoria('Moto2') },

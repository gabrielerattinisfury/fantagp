...
function PaginaNuovoUtenteInterna() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    if (moto3A === moto3B || moto3A === moto3C || moto3B === moto3C) {
      setErrore('I 3 piloti Moto3 devono essere tutti diversi.');
      return;
    }
    if (moto2A === moto2B || moto2A === moto2C || moto2B === moto2C) {
      setErrore('I 3 piloti Moto2 devono essere tutti diversi.');
      return;
    }
    ...
    try {
      const res = await fetch('/api/admin/utenti/crea', {
        ...
        body: JSON.stringify({
          ...
          stagioneId,
          rosa: { moto3A, moto3B, moto3C, moto2A, moto2B, moto2C, motoGpA, motoGpB, motoGpC },
        }),
      });
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <p className="text-sm text-asfalto-400 mt-0.5">Crea l&apos;account e assegna la rosa iniziale (3+3+3)</p>
      </div>

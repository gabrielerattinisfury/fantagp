...
function PaginaFormazioneInterna() {
  ...
  const opzioniMoto3 = dati.rosaAttiva
    .filter((r) => r.slot === 'moto3_a' || r.slot === 'moto3_b' || r.slot === 'moto3_c')
    .map((r) => ({
  ...
  const opzioniMoto2 = dati.rosaAttiva
    .filter((r) => r.slot === 'moto2_a' || r.slot === 'moto2_b' || r.slot === 'moto2_c')
    .map((r) => ({
      pilotaId: r.pilota_id,
      nome: r.nome_completo,
      numero: r.numero,
  ...
  return (
    <div className="pb-24 md:pb-4">
      <div className="space-y-6">
        ...
        <div className="glass rounded-2xl px-4 py-3 text-xs text-asfalto-400 flex items-start gap-2">

"""
Genera le icone PWA dell'app FantaGP in tutte le dimensioni richieste.
...
# Percorso relativo allo script stesso (non un path assoluto legato a una
# singola macchina): funziona indipendentemente da dove viene clonato il repo.
# La cartella reale nel progetto è "public/icon" (singolare).
OUT_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "public", "icon")

...
const VOCI_NAV = [
  ...
  { href: '/statistiche', label: 'Statistiche', icona: 'ti-chart-bar' },
...
export function NavigazionePrincipale() {
  ...
  return (
    <>
      ...
      <header className="hidden md:flex sticky top-0 z-30 items-center justify-between px-6 py-3 bg-asfalto-900/80 backdrop-blur-xl backdrop-saturate-150 border-b border-white/10 shadow-lg shadow-black/20">
        <div className="flex items-center gap-8">
          <Link href="/formazione" className="flex items-center gap-2">
            ...
            <span className="font-display font-semibold tracking-tight text-lg">FantaGP</span>
          </Link>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-30 bg-asfalto-900/85 backdrop-blur-xl backdrop-saturate-150 border-t border-white/10 shadow-[0_-8px_24px_rgba(0,0,0,0.35)] pb-[env(safe-area-inset-bottom)]">

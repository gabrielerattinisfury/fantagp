        ...
        {opzioni.map((opzione) => {
          ...
          return (
            <button
              ...
              className={`glass-hover flex items-center gap-3 rounded-2xl border px-3.5 py-3 text-left transition-all duration-200 ${
              ...
              style={
                selezionato
                  ? {
                      ...
                      borderColor: `${colore}80`,
                      boxShadow: `0 8px 24px -8px ${colore}40, inset 0 1px 0 rgba(255,255,255,0.08)`,
                    }
                  : undefined
              }
            >
